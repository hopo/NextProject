...
-- T09 TB_PRESCRIPTION
DROP TABLE "JAVA"."TB_PRESCRIPTION";
CREATE TABLE
...
-- T12 TB_MED_CODENAME
DROP TABLE "JAVA"."TB_MED_CODENAME";
CREATE TABLE
...
-- T13 TB_BUSICOMPANY
DROP TABLE "JAVA"."TB_BUSICOMPANY";
CREATE TABLE
	"JAVA"."TB_BUSICOMPANY"(
