...
INSERT ALL 
	...
	INTO tb_notice (ntc_idx, ntc_title, emp_id, ntc_content, ntc_count, ntc_regdate)
		VALUES (313, '제목13목', 'nanana', '치질약을 먹읍시다', 42, SYSDATE)
	INTO tb_notice (ntc_idx, ntc_title, emp_id, ntc_content, ntc_count, ntc_regdate)
...
INSERT ALL
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10001', 'p00042', 'san', SYSDATE, '진료내용c10001입니다아아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10002', 'p00042', 'san', SYSDATE, '진료내용c10002입니다아아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10003', 'p00042', 'san', SYSDATE, '진료내용입c10003니다아아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10004', 'p00042', 'san', SYSDATE, '진료내용입니c10004다아아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10005', 'p00042', 'san', SYSDATE, '진료내용입니다아c10005아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10006', 'p00042', 'san', SYSDATE, '진료내c10006용입니다아아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10007', 'p00042', 'san', SYSDATE, '진료내용입니다c10007아아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10008', 'p00042', 'san', SYSDATE, '진료내용입니다c10008아아아아')
	INTO tb_clinic (cln_code, pat_code, emp_id, cln_date, cln_descr)
		VALUES('c10009', 'p00042', 'san', SYSDATE, '진료내c10009용입니다아아아아')
SELECT 1 FROM dual;
